...
def get_flags():
    ...
    gflags.DEFINE_enum("dataset", "drug_disease", ["drug_disease", "drug_drug", "gene_phenotype"], "including ratings.csv, r2kg.tsv and a kg dictionary containing kg_hop[0-9].dat")
    gflags.DEFINE_bool(
